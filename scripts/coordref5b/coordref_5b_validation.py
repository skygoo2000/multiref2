...
from videox_fun.models.multiref_transformer3d import CroodRefTransformer3DModel2_2
from videox_fun.pipeline import WanFunCroodRefPipeline2_2
...
def parse_args():
    parser = argparse.ArgumentParser(description="Validation script for CroodRef 5B model")
    
    parser.add_argument("--config_path", type=str, default="config/wan2.2/wan2.2_5B.yaml", help="Path to config file")
...
def main():
    ...
    # Get Transformer - use CroodRefTransformer3DModel2_2 for 5B
    transformer = CroodRefTransformer3DModel2_2.from_pretrained(
