...
export DATASET_NAME="datasets/pose10k"
export DATASET_META_NAME="$DATASET_NAME/pose10k.json"
...
OUTPUT_DIR="ckpts/1215_poseref14B_pose10k_lr${LEARNING_RATE}_selfattn"
